...
$string['Accestoken'] = 'Llave de acceso al api del comercio.';
...
$string['paymentconfirm'] = 'Curso pagado, resumen: <div id="idpagomercadopago"><br>Id de pago: "{$a->payment_id}"<br>Estado del pago: "{$a->payment_status}"<br>Estado: "{$a->payment_status_detail}"<br></div>';
