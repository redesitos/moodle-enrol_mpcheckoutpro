...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext(
        ...
        get_string('Accestoken', 'enrol_mpcheckoutpro'),
        'Access token from api prod & paste here',
        '',
        PARAM_RAW
    ));
    $settings->add(new admin_setting_configtext(
        ...
        'Public key from api prod & paste here',
        '',
        PARAM_RAW
    ));
    $settings->add(new admin_setting_configtext(
    ...
    $settings->add(new admin_setting_configtext(
        ...
        'Add your url for map in notification of transaction',
        '',
        PARAM_RAW
    ));
